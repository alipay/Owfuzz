...
struct packet create_vht_ndp_announcement(struct ether_addr bssid, struct ether_addr smac, struct ether_addr dmac)
{
    struct packet pkt = {0};
    struct ieee_hdr *hdr;
    uint8_t rlen = 0;
    ...
    // fuzz_logger_log(FUZZ_LOG_DEBUG, "VHT NDP Announcement testing");
